...
// https://github.com/khalidabuhakmeh/ConsoleTables/blob/master/LICENSE
...
namespace AppGet.CommandLine
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = CommandLine.Format.Default)
        {
            switch (format)
            {
                case CommandLine.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case CommandLine.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case CommandLine.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case CommandLine.Format.Minimal:
