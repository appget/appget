...
namespace AppGet.Installers.Inno
{
    public class InnoWhisperer : InstallerWhispererBase
    {
        ...
        public override Dictionary<int, ExistReason> ExitCodes => new Dictionary<int, ExistReason>
        {
            ...
            {2, new ExistReason(ExitCodeTypes.UserCanceled)},{3,new ExistReason(ExitCodeTypes.Failed,"A fatal error occurred while preparing to move to the next installation phase. This should never happen except under the most unusual of circumstances, such as running out of memory or Windows resources.")},
            ...
            {8,new ExistReason(ExitCodeTypes.RestartRequired,"The Preparing to Install stage determined that Setup cannot proceed with installation, and that the system needs to be restarted in order to correct the problem.")},
