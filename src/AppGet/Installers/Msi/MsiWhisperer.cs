...
namespace AppGet.Installers.Msi
{
    public class MsiWhisperer : InstallerWhispererBase
    {
        ...
        public override Dictionary<int, ExistReason> ExitCodes => new Dictionary<int, ExistReason>
        {
            ...
            {   120, new ExistReason(ExitCodeTypes.Failed,"ERROR_CALL_NOT_IMPLEMENTED: This value is returned when a custom action attempts to call a function that cannot be called from custom actions.")},
            {   1259, new ExistReason(ExitCodeTypes.RequirementUnmet)},
            {   1601, new ExistReason(ExitCodeTypes.Failed, "The Windows Installer service could not be accessed. Contact your support personnel to verify that the Windows Installer service is properly registered.")},
            ...
            {   1610, new ExistReason(ExitCodeTypes.Failed,"ERROR_BAD_CONFIGURATION: The configuration data for this product is corrupt. Contact your support personnel.")},
            {   1611, new ExistReason(ExitCodeTypes.Failed,"ERROR_INDEX_ABSENT: The component qualifier not present.")},
            {   1612, new ExistReason(ExitCodeTypes.Failed,"ERROR_INSTALL_SOURCE_ABSENT: The installation source for this product is not available. Verify that the source exists and that you can access it.")},

            {   1613, new ExistReason(ExitCodeTypes.RequirementUnmet,"This installation package cannot be installed by the Windows Installer service. You must install a Windows service pack that contains a newer version of the Windows Installer service.")},
            ...
            {   1618, new ExistReason(ExitCodeTypes.Failed,"Another installation is already in progress. Complete that installation before proceeding with this install.")},
            {   1619, new ExistReason(ExitCodeTypes.Failed,"This installation package could not be opened. Verify that the package exists and is accessible, or contact the application vendor to verify that this is a valid Windows Installer package.")},
            {   1620, new ExistReason(ExitCodeTypes.Failed,"This installation package could not be opened. Contact the application vendor to verify that this is a valid Windows Installer package.")},
            {   1621, new ExistReason(ExitCodeTypes.Failed,"There was an error starting the Windows Installer service user interface. Contact your support personnel.")},
            {   1622, new ExistReason(ExitCodeTypes.Failed,"There was an error opening installation log file. Verify that the specified log file location exists and is writable.")},
            ...
            {   1631, new ExistReason(ExitCodeTypes.Failed,"ERROR_CREATE_FAILED: The Windows Installer service failed to start. Contact your support personnel.")},
            {   1632, new ExistReason(ExitCodeTypes.Failed,"The Temp folder is either full or inaccessible. Verify that the Temp folder exists and that you can write to it.")},
            ...
            {   1635, new ExistReason(ExitCodeTypes.CorruptInstaller,"This patch package could not be opened. Verify that the patch package exists and is accessible and is a valid Windows Installer patch package.")},
            {   1636, new ExistReason(ExitCodeTypes.CorruptInstaller,"This patch package could not be opened. Verify that this is a valid Windows Installer patch package.")},
            {   1637, new ExistReason(ExitCodeTypes.RequirementUnmet,"This patch package cannot be processed by the Windows Installer service. You must install a Windows service pack that contains a newer version of the Windows Installer service.")},
            {   1638, new ExistReason(ExitCodeTypes.RequirementUnmet,"Another version of this product is already installed. Installation of this version cannot continue.")},
            ...
            {   1651, new ExistReason(ExitCodeTypes.RestartRequired,"Administrative user failed to apply patch for a per-user managed or a per-machine application that is in advertise state.")},
            {   1652, new ExistReason(ExitCodeTypes.RestartRequired,"Windows Installer is not accessible when the computer is in Safe Mode. Exit Safe Mode and try again or try using System Restore to return your computer to a previous state.")},
